...
try:
    ...
    raise ModuleNotFoundError('privacyHE depends on the SEAL-Python library. See https://github.com/Huelse/SEAL-Python for installation instructions.')
...
from privacyHE.encryptors import encrypt
from privacyHE.decryptors import decrypt
from privacyHE.datatypes import load_encrypted_value
