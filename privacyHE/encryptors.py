...
from privacyHE.datatypes import EncryptedValue


def encrypt(item) -> EncryptedValue:
    encryptor = privacyHE._encryptor
...
def encode_int(item: int) -> Plaintext:
    ...
    modulus = privacyHE._mode['modulus']
